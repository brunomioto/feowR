...
**feowR** provides a faster and secure way to download shapefiles of Freshwater Ecoregions of the World (FEOW) using [piggyback](https://docs.ropensci.org/piggyback/index.html) R package.
